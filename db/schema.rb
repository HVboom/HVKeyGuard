...
ActiveRecord::Schema[7.1].define(version: 2024_04_15_083142) do
  create_table "access_groups", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name", comment: "Identifier of the access group"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "access_groups_users", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "current_sign_in_at", precision: nil, comment: "Latest login timestamp"
    t.datetime "last_sign_in_at", precision: nil, comment: "Last visit timestamp"
    ...
    t.datetime "locked_at", precision: nil, comment: "Used to look the user for some time"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
